...
export default function Broadcasts() {
    ...
    return (
        <div
            ...
            style={{
                backgroundImage: "url('/background/bkg2.png')",
            }}
        >
            <Navbar />

            <div className="max-w-5xl mx-auto pt-24 px-6 pb-20">
                <div className="backdrop-blur-md bg-white/40 p-6 rounded-3xl shadow-xl">
                    <h1 className="text-3xl font-bold mb-6">Broadcasts</h1>

                    {/* —— 以下内容保持原样 —— */}
                    {/* 区域筛选 */}
                    <div className="mb-6 flex gap-3 items-center">
                        <span className="text-gray-700 text-sm">Filter by area:</span>
                        <select
                            value={selectedArea}
                            onChange={(e) =>
                                setSelectedArea(
                    ...
                    {loading ? (
                        ...
                        <p className="text-gray-700">No broadcasts yet.</p>
                    ) : (
                        <div className="space-y-4">
                            {broadcasts.map((b) => (
                                <div
                                    key={b.broadcast_id}
                                    className="bg-white/70 p-4 rounded-xl shadow-sm backdrop-blur"
                                >
                    ...
                    {isWriting && (
                        <div className="bg-white/70 p-6 rounded-xl mt-8 space-y-4 backdrop-blur">
                            <div>
