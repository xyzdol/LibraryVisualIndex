        ...
        <div>
            ...
            <div className="pt-24 px-8 max-w-6xl mx-auto">
                ...
                <p className="text-gray-500 mb-4">
                    Click a shelf to view the books on it.
                </p>
                                        ...
                                        {floorShelves.map((shelf) => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`border ${colorClass} rounded-xl px-2 py-2 text-sm flex flex-col items-start justify-center hover:shadow-md hover:-translate-y-0.5 transition`}
                                                    onClick={() =>
